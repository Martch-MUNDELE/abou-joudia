...
export default function ConfirmationPage() {
  ...
  if (loading) return (
    <div style={{ textAlign: 'center', padding: '80px 20px', color: '#7A6E58' }}>Chargement...</div>
  )

  if (!order) return (
    <div style={{ textAlign: 'center', padding: '80px 20px' }}>
      <p style={{ color: '#7A6E58' }}>Commande introuvable</p>
    ...
    <div style={{ maxWidth: 520, margin: '0 auto', padding: '0 20px 80px' }}>
      ...
      {slot && (
        <div style={{ background: '#131009', border: '1px solid rgba(232,160,32,0.15)', borderRadius: 18, padding: '20px', marginBottom: 12 }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: '#7A6E58', letterSpacing: '1px', textTransform: 'uppercase' as const, marginBottom: 14 }}>Livraison prévue</div>
      ...
      <div style={{ background: '#131009', border: '1px solid rgba(232,160,32,0.1)', borderRadius: 18, padding: '20px', marginBottom: 24 }}>
        <div style={{ fontSize: 11, fontWeight: 700, color: '#7A6E58', letterSpacing: '1px', textTransform: 'uppercase' as const, marginBottom: 14 }}>Récapitulatif</div>
